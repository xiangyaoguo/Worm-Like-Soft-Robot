...
class SeedRuntime:
    ...
    def __init__(self, seed: int, stage: str, environment_arm: str = "Rroll") -> None:
        ...
        self.formal_root = Path(self.config["formal_root"]).resolve()
        self.snapshot = self.formal_root / "_control" / "code_snapshot"
        ...
        run_root = self.formal_root / "formal" / "runs"
        self.r0_checkpoint = (
    ...
    def official_evaluation(self, arm: str) -> dict[str, Any]:
        path = (
            ...
            / "formal"
            / "evaluations"
            / f"formal__seed{self.seed}__{arm}__eval_attempt1.json"
        )
