...
#   .\run_seed1_stairs_k2_sign_ppo.ps1
...
# Common settings matching the previous stairs/PPO/seed1 comparison runs.
$CommonArgs = @(
    $TrainScript,
    "--terrain", "stairs",
    "--algorithm", "ppo",
...
$Experiments = @(
    @{ Robot = "crawler"; Channel = "k2_positive"; RunName = "crawler_stairs_k2_positive_ppo_seed1" },
    @{ Robot = "crawler"; Channel = "k2_negative"; RunName = "crawler_stairs_k2_negative_ppo_seed1" },
    @{ Robot = "ring";    Channel = "k2_positive"; RunName = "ring_stairs_k2_positive_ppo_seed1" },
    @{ Robot = "ring";    Channel = "k2_negative"; RunName = "ring_stairs_k2_negative_ppo_seed1" }
)
